# AI4I-Observe Documentation

## Welcome to AI4I-Observe
- [Introduction](welcome/introduction.md)
- [Why Observability for Language AI](welcome/why-observability-for-language-ai.md)
- [The Language AI Quality Lifecycle](welcome/language-ai-quality-lifecycle.md)
- [Challenges Without Observe](welcome/challenges-without-observe.md)
- [The Solution: AI4I-Observe](welcome/the-solution-ai4i-observe.md)

## Core Concepts
- [AI4I-Observe Overview](core-concepts/ai4i-observe-overview.md)
...
- [Signals and Telemetry](core-concepts/signals-and-telemetry.md)
- [Quality Metrics and Drift](core-concepts/quality-metrics-and-drift.md)
- [Feedback Types](core-concepts/feedback-types.md)
- [Scope and Boundaries](core-concepts/scope-and-boundaries.md)

## Explore
- [Roadmap](explore/roadmap.md)
- [Case Studies](explore/case-studies/multilingual-citizen-services.md)
  - [Multilingual Citizen Services](explore/case-studies/multilingual-citizen-services.md)
  - [Voice-based DPI Systems](explore/case-studies/voice-based-dpi-systems.md)
  - [Language AI Governance](explore/case-studies/language-ai-governance.md)
...
- [Telemetry APIs](guides/apis/telemetry-apis.md)
- [Metrics APIs](guides/apis/metrics-apis.md)
- [Feedback APIs](guides/apis/feedback-apis.md)
- [Audit APIs](guides/apis/audit-apis.md)
